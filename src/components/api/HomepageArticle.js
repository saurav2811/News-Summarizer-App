...
const HomepageArticle = ({article}) => {
    ...
    if(article.urlToImage === null){
        ...
        <button className="button"><span><a target="_parent" href="http://localhost:3000/topstories">See all news</a></span></button>
        </div>
        </div>
    }
    ...
    return (
        <div className = 'homepage-article-item'>
            ...
            <div id="homepage-article-button">
                <button className="button"><span><a target="_blank" href="http://localhost:3000/topstories">See all news</a></span></button>
            </div>
        </div>
    )
}
